...
import static com.finbertmds.microservice.message.entity.PersistentTokenEntity.TOKEN_VALIDITY_SECONDS;
...
import com.finbertmds.microservice.message.security.repository.PersistentTokenRepository;
...
public class CustomPersistentRememberMeService extends
    ...
    public CustomPersistentRememberMeService(Environment env, org.springframework.security.core.userdetails.UserDetailsService userDetailsService) {
        ...
        super(env.getProperty("chatapp.security.rememberme.key"), userDetailsService);
