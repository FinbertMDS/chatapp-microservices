...
@Table(Schema.PERSISTENT_TOKEN)
public class PersistentTokenEntity implements Serializable {

    /**
     *
     */
    private static final long serialVersionUID = -8841082922726629967L;
    ...
    public PersistentTokenEntity(String series, String tokenValue, Date tokenDate, String ipAddress, String userAgent,
            String login, String pass, Set<@Frozen UserAuthority> authorities) {
        this.series = series;
